...
def get_my_reports_route(
    ...
    """
    return get_user_reports(user_id=current_user.id, db=db)
...
def get_report_route(
    ...
    return get_report_by_id(report_id=report_id, user_id=current_user.id, db=db)