...
def create_progression_route(
    ...
    """
    return create_progression(
        user_id=current_user.id,
        progression_score=payload.progression_score,
        progression_stage=payload.progression_stage,
...
def get_all_progressions_route(
    ...
    the route structure.
    """
    return get_all_progressions(db=db)
